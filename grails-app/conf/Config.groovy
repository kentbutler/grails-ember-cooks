...
environments {
	...
	test {
		...
		log4j = {
			appenders {
				rollingFile name:"cook", maxFileSize:"10000KB", maxBackupIndex:10, file:"logs/unittest/cook.log",layout:pattern(conversionPattern: '%d{yyyy-MM-dd HH:mm:ss,SSS z} [%t] %-5p[%c]: %m%n')
